...
- 2025-11-20 現在の進捗: YouTube(Final Fantasy X OST) 88/88 pass、Spotify(Nobuo Uematsu artist top-tracks, market=JP) 10/10 pass を本番しきい値で確認し pipeline cron デプロイ済み。未実装のハードニング項目（音声計測、近傍一致 dedup、指数バックオフ、昇格フロー整備）は Issue #151 で管理。
